...
public class DemoPhotoActivity extends BaseActivity {

  private static final String KEY_DEMO = "demo";

  public static void startActivity(Context context, Demo demo) {
    Intent intent = new Intent(context, DemoPhotoActivity.class);
  ...
  public void onPostCreate(Bundle savedInstanceState) {
    ...
    for (int titleResId : demo.tabs()) {
      pages.add(FragmentPagerItem.of(getString(titleResId), DemoPhotoFragment.class));
    }
